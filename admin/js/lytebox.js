	...
	for (var i = 0; i < anchors.length; i++) {
		...
		if (anchor.getAttribute('href')) {
			if (relAttribute.toLowerCase().match('lytebox')) {
				anchor.onclick = function () { myLytebox.start(this, false, false, false); return false; }
			} else if (relAttribute.toLowerCase().match('lyteshow')) {
				anchor.onclick = function () { myLytebox.start(this, true, false, false); return false; }
			} else if (relAttribute.toLowerCase().match('lyteframe')) {
				anchor.onclick = function () { myLytebox.start(this, false, true, false); return false; }
			} else if (relAttribute.toLowerCase().match('lytebubble')) {
				anchor.onclick = function () { myLytebox.start(this, false, false, true); return false; }
			}
...
//********************************************************************************/
LyteBox.prototype.start = function(imageLink, doSlide, doFrame, doBubble) {
	...
	this.isLytebubble = (doBubble ? true : false);
	...
	if (this.isLyteframe) {
		...
		if ((imageLink.getAttribute('rel') == 'lytebox') || (imageLink.getAttribute('rel') == 'lytebubble')) {	// add single image to imageArray
		...
		/* if its a bubble then outerBorder = false  */
		if (this.isLytebubble) { 
...
LyteBox.prototype.showContent = function() {
	if (this.wDone && this.hDone) {
		...
		if (this.isLytebubble) {
			this.doc.getElementById('lbOuterContainer').style.background = 'none';
			this.doc.getElementById('lbImageContainer').style.background = 'none';
			this.doc.getElementById('lbHoverNav').style.background = 'none';
			this.doc.getElementById('lbDetailsContainer').style.background = 'none';
			
			this.doc.getElementById('lbDetails').style.display = 'none';
			this.doc.getElementById('lbClose').style.display = 'none';
			/*
			this.doc.getElementById('lbClose').style.backgroundColor = '#FFF';
			this.doc.getElementById('lbClose').style.padding = '0px 0px 0px 0px';
			this.doc.getElementById('lbClose').style.border = '3px solid #FFF';*/
