   ...
   */        
   ...
   { 
     ...
     while((inputObj = inputObj.offsetParent) != null){ 
        if(inputObj.parentNode.id=='ancs_menu')topOfMenuReached=true; 
   ...
   { 
      ...
      while(parent && parent.id && parent.tagName=='UL'){ 
         ...
         var li = document.getElementById('ancs_listItem' + parent.id.replace(/[^0-9]/g,'')); 
      ...
      for(var no=0;no<visibleMenus.length;no++){ 
         if(visibleMenus[no].className!='menuBlock1' && visibleMenus[no].id){ 
            if(!exceptionArray[visibleMenus[no].id]){ 
               ...
               var li = document.getElementById('ancs_listItem' + visibleMenus[no].id.replace(/[^0-9]/g,'')); 
   ...
   {    
      ...
      if(subUl.length>0){ 
         ...
         ul = ancs_menuObj.appendChild(ul); 
   ...
   function resizeMenu() 
   { 
      var offsetParent = getLeftPos(ancs_menuObj); 
   ...
   */ 
   ...
   { 
      ancs_menuObj = document.getElementById('ancs_menu'); 
        
        
      var aTags = ancs_menuObj.getElementsByTagName('A'); 
      for(var no=0;no<aTags.length;no++){          

         var subUl = aTags[no].parentNode.getElementsByTagName('UL'); 
         if(subUl.length>0 && aTags[no].parentNode.parentNode.parentNode.id != 'ancs_menu'){ 
            var img = document.createElement('IMG'); 
            img.src = ancs_menu_arrow;
      ...
      var mainMenu = ancs_menuObj.getElementsByTagName('UL')[0]; 
      ...
      while(mainMenuItem){ 
         ...
         mainMenuItem.id = 'ancs_listItem' + liIndex; 
      ...
      menuParentOffsetLeft = getLeftPos(ancs_menuObj);    
      window.onresize = resizeMenu;    
      ancs_menuObj.style.visibility = 'visible';    
   } 
